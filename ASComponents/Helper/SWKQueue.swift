...
private let globalMainQueue = SWKQueue(queue: DispatchQueue.main, specialIsMainQueue: true)
private let globalDefaultQueue = SWKQueue(queue: DispatchQueue.global(qos: .default), specialIsMainQueue: false)
private let globalBackgroundQueue = SWKQueue(queue: DispatchQueue.global(qos: .background), specialIsMainQueue: false)

internal final class SWKQueue {
    ...
    public class func mainQueue() -> SWKQueue {
        return globalMainQueue
    }
    
    public class func concurrentDefaultQueue() -> SWKQueue {
        return globalDefaultQueue
    }
    
    public class func concurrentBackgroundQueue() -> SWKQueue {
